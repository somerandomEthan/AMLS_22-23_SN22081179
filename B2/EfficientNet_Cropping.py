...
def extract_images_labels(final_image_dir, cartoon_images_dir, labels_filename):
    ...
    if os.path.isdir(cartoon_images_dir):
        ...
        for img_path in image_paths:
            ...
            (h, w) = res.shape[:2]
            cropped = res[40:h-40, 40:w-40] # center crop 
...
def create_EfficientNetV2B0_model(optimizer='adam', learn_rate=0.001, amsgrad=False,):
    num_classes = 5
    base_model = EfficientNetV2B0(include_top=False, weights='imagenet', input_tensor=None, input_shape=(48, 48, 3), pooling=None, classifier_activation='softmax')
